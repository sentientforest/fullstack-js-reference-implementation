...
// This is a mock Node.js / Express controller.
// A real-world application would obviously persist data,
// most likely in a database or via REST calls to other APIs or microservices.
// changes made during development will disappear
// anytime the application is restarted.

var countries = countriesDefault();

exports.saveCountry = function saveContext(req, res) {
  var country = req.body
  if ((req.method === 'PUT' || req.method === 'PATCH') && req.params.code) {
    for (var i = 0; i < countries.length; i++) {
      if (countries[i]['geoname_id'] === req.params.code) {
        countries[i] = Object.assign(
          countries[i], country
        );
        break;
      }
    ...
    if (typeof country['geoname_id'] === 'undefined') {
      country['geoname_id'] = 'test-country-' + countries.length + 1;
    }
...
exports.deleteCountry = function deleteCountryById(req, res) {
...
exports.findCountry = function findCountryById(req, res) {
  var code = req.params.code
  var country = null
  for (var i = 0; i < countries.length; i++) {
...
// author notes that this is pulled from https://www.geonames.org/
// which currently lists a license of CC-BY-4.0
